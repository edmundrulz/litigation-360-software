...
Write-Host "===================================================="
Write-Host "PHASE 10ZZG.5 FILE VERIFICATION"
Write-Host "===================================================="

$Required = @(
  "backend\admin\trial-admin.js",
...
if ($Fail -eq 0) {
  Write-Host "??? PHASE 10ZZG.5 FILE VERIFICATION PASSED"
} else {
  Write-Host "? PHASE 10ZZG.5 FILE VERIFICATION FAILED"
}

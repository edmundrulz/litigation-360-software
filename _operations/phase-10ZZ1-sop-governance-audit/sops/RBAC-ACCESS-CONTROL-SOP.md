...
## Purpose
Define the standard operating procedure for RBAC within Litigation 360.

## Scope
Applies to all users, operators, administrators and governance reviewers involved in RBAC.

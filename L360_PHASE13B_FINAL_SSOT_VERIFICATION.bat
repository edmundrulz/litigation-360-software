@echo off
setlocal
title L360 PHASE 13B FINAL SSOT VERIFICATION

set "WORKSPACE=C:\Users\jep_edmundrulz\litigation-360-workspace"
set "RUNNER=%WORKSPACE%\_L360_RUNNER"
set "SOURCE_PS1=%~dp0L360_PHASE13B_FINAL_SSOT_VERIFICATION.ps1"
set "TARGET_PS1=%RUNNER%\L360_PHASE13B_FINAL_SSOT_VERIFICATION.ps1"

if not exist "%SOURCE_PS1%" (
  echo ERROR: L360_PHASE13B_FINAL_SSOT_VERIFICATION.ps1 not found beside this BAT.
  pause
  exit /b 1
)

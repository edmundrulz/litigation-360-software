...
# Phase 14A Clients Section Reorder Pass 3 Employment & Organisation Local Map
...
This read-only map identifies exact Clients.jsx anchors before applying Pass 3 Employment & Organisation alignment.

No code changes are made by this map.

## 2. Landmark Search Results

### Pattern: client-employment-details
- Line 2017: { anchor: "client-employment-details", label: "Employment" },
- Line 3977: <li><a href="#client-employment-details" className="client-profile-summary-link">Employment Details</a></li>
- Line 4464: <h3 id="client-employment-details"><span className="client-profile-card-kicker">Section 3</span><span className="client-profile-card-title">Employment Details</span><span className="client-profile-card-status">Profile metadata</span></h3>

### Pattern: Employment Details
- Line 3977: <li><a href="#client-employment-details" className="client-profile-summary-link">Employment Details</a></li>
- Line 4464: <h3 id="client-employment-details"><span className="client-profile-card-kicker">Section 3</span><span className="client-profile-card-title">Employment Details</span><span className="client-profile-card-status">Profile metadata</span></h3>

### Pattern: Employment
- Line 13: "Employment Matter",
- Line 86: employmentStatus: "To be confirmed",
- Line 504: "Employment Pass",
- Line 530: const EMPLOYMENT_STATUS_OPTIONS = [
- Line 1317: employmentStatus: source.employmentStatus || "To be confirmed",
- Line 2017: { anchor: "client-employment-details", label: "Employment" },
- Line 3483: normalized.employmentStatus,
- Line 3977: <li><a href="#client-employment-details" className="client-profile-summary-link">Employment Details</a></li>
- Line 4464: <h3 id="client-employment-details"><span className="client-profile-card-kicker">Section 3</span><span className="client-profile-card-title">Employment Details</span><span className="client-profile-card-status">Profile metadata</span></h3>
- Line 4465: <p className="client-profile-card-help">Employment and organisation-related details. Existing fields and rules remain preserved.</p>
- Line 4469: Employment Status
- Line 4470: <select value={form.employmentStatus} onChange={(event) => updateForm("employmentStatus", event.target.value)}>
- Line 4471: {EMPLOYMENT_STATUS_OPTIONS.map((option) => (
- Line 5833: <th>Employment</th>
- Line 5891: <td>{normalized.employmentStatus || "-"}</td>

### Pattern: organisation
- Line 4465: <p className="client-profile-card-help">Employment and organisation-related details. Existing fields and rules remain preserved.</p>
- Line 5754: <p>Confirm legal name, title authority, gender/title override reason, organisation details where present, identification reference, and profile classification.</p>
...
### Pattern: company
- Line 539: "Company Director",
- Line 753: "Company Contact Person",
...
### Pattern: profession
- Line 506: "Professional Visit Pass",

### Pattern: Profession
- Line 506: "Professional Visit Pass",

### Pattern: business
- Line 538: "Business Owner",
- Line 617: "Business",
- Line 5021: <p className="mandatory-note">Use this section for residential, business, local, overseas, correspondence, courier and service-location details.</p>
...
### Pattern: occupationJobTitle
- Not found

### Pattern: employerName
- Not found
...
### Context for pattern client-employment-details around line 2017
TEXT_BLOCK_START
 2007:         </span>
 2008:       </div>
 2009:     </div>
...
### Context for pattern client-employment-details around line 3977
TEXT_BLOCK_START
 ...
 3977:               <li><a href="#client-employment-details" className="client-profile-summary-link">Employment Details</a></li>
...
### Context for pattern client-employment-details around line 4464
TEXT_BLOCK_START
 4454:                 <input
 ...
 4464:           <h3 id="client-employment-details"><span className="client-profile-card-kicker">Section 3</span><span className="client-profile-card-title">Employment Details</span><span className="client-profile-card-status">Profile metadata</span></h3>
 4465:           <p className="client-profile-card-help">Employment and organisation-related details. Existing fields and rules remain preserved.</p>
 4466:
...
### Context for pattern Employment Details around line 3977
TEXT_BLOCK_START
 3967:               Summary navigation for the preserved Clients workflow. Original fields, validation, backend checks,
 3968:               local fallback, draft behaviour, required-field rules, and manual management protocols remain unchanged.
 3969:             </p>
...
### Context for pattern Employment Details around line 4464
TEXT_BLOCK_START
 4454:                 <input
 4455:                   value={form.ethnicityOther}
 4456:                   onChange={(event) => updateForm("ethnicityOther", event.target.value)}
...
### Context for pattern Employment around line 13
TEXT_BLOCK_START
    3: const CLIENT_DIRECTORY_ALPHABET = "ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");
    4:
    5: const DEFAULT_CLIENT_TAG_OPTIONS = [
    6:   "General",
    7:   "Important",
    8:   "Urgent",
    9:   "VIP",
   ...
   12:   "Court Matter",
   13:   "Employment Matter",
   14:   "Medical Matter",
   15:   "Police / Authority Matter",
   16:   "Billing / Invoice Matter",
   17:   "Follow Up Required",
   18:   "Archived / Dormant"
   19: ];
   20:
   21: function getClientDirectoryName(client) {
   22:   const source = client || {};
   23:   return (
   24:     [source.givenName, source.surname].filter(Boolean).join(" ") ||
   25:     source.name ||
   26:     source.full_name ||
   27:     source.fullName ||
   28:     source.email ||
   29:     source.phoneNumber ||
   30:     "Unnamed client"
   31:   );
   32: }
   33:
   34: function getClientDirectoryInitial(client) {
   35:   const name = getClientDirectoryName(client).trim();
   36:   const first = name.charAt(0).toUpperCase();
   37:   return /^[A-Z]$/.test(first) ? first : "#";
   38: }
   39:
   40: function normalizeClientTagList(value) {
   41:   if (Array.isArray(value)) {
TEXT_BLOCK_END

### Context for pattern Employment around line 86
TEXT_BLOCK_START
   76:   initials: "",
   77:
   78:   gender: "",
...
### Context for pattern Employment around line 504
TEXT_BLOCK_START
  494: ];
  495:
  496: const RESIDENCY_STATUS_OPTIONS = [
  497:   "Not Applicable / N/A",
...
### Context for pattern Employment around line 530
TEXT_BLOCK_START
  520:   "Passport",
  521:   "Permanent Resident Document",
  522:   "Work Visa / Work Permit",
...
### Context for pattern Employment around line 1317
TEXT_BLOCK_START
 1307:     initials: source.initials || makeInitials(givenName, surname),
 1308:
 1309:     gender,
...
### Context for pattern Employment around line 2017
TEXT_BLOCK_START
 2007:         </span>
 2008:       </div>
 2009:     </div>
...
### Context for pattern Employment around line 3483
TEXT_BLOCK_START
 3473:         normalized.titlePrefix,
...
### Context for pattern Employment around line 3977
TEXT_BLOCK_START
 3967:               Summary navigation for the preserved Clients workflow. Original fields, validation, backend checks,
 3968:               local fallback, draft behaviour, required-field rules, and manual management protocols remain unchanged.
 3969:             </p>
...
### Context for pattern Employment around line 4464
TEXT_BLOCK_START
 4454:                 <input
 4455:                   value={form.ethnicityOther}
 4456:                   onChange={(event) => updateForm("ethnicityOther", event.target.value)}
...
### Context for pattern Employment around line 4465
TEXT_BLOCK_START
 4455:                   value={form.ethnicityOther}
 4456:                   onChange={(event) => updateForm("ethnicityOther", event.target.value)}
 4457:                   placeholder="Describe ethnicity"
...
### Context for pattern Employment around line 4469
TEXT_BLOCK_START
 4459:               </label>
 4460:             )}
 4461:           </div>
...
### Context for pattern Employment around line 4470
TEXT_BLOCK_START
 4460:             )}
 4461:           </div>
 4462:         </div>
...
### Context for pattern Employment around line 4471
TEXT_BLOCK_START
 4461:           </div>
 4462:         </div>
 4463:         <div className="form-section">
...
### Context for pattern Employment around line 5833
TEXT_BLOCK_START
...
### Context for pattern Employment around line 5891
TEXT_BLOCK_START
 5881:
 5882:               return (
...
### Context for pattern organisation around line 4465
TEXT_BLOCK_START
 4455:                   value={form.ethnicityOther}
 4456:                   onChange={(event) => updateForm("ethnicityOther", event.target.value)}
 4457:                   placeholder="Describe ethnicity"
...
### Context for pattern organisation around line 5754
TEXT_BLOCK_START
 5744:                 backend checks, draft behaviour, or save controls.
 5745:               </p>
 5746:             </div>
 5747:             <span className="client-profile-review-status">Verify before saving</span>
 5748:           </div>
 5749:
 5750:           <div className="client-profile-review-grid">
 5751:             <article className="client-profile-review-card">
 5752:               <p className="client-profile-review-kicker">Identity</p>
 5753:               <h4>Client Identity & Authority Review</h4>
 5754:               <p>Confirm legal name, title authority, gender/title override reason, organisation details where present, identification reference, and profile classification.</p>
 5755:               <a href="#client-profile-details" className="client-profile-review-link">Jump to Client Identity & Authority</a>
 5756:             </article>
 5757:
 5758:             <article className="client-profile-review-card">
 5759:               <p className="client-profile-review-kicker">Verification</p>
 5760:               <h4>Identification & Documentation</h4>
 5761:               <p>Check identification details, document status, pending document reasons, and verification notes.</p>
 5762:               <a href="#client-documentation-verification" className="client-profile-review-link">Jump to Documentation Verification</a>
 5763:             </article>
 5764:
 5765:             <article className="client-profile-review-card">
 5766:               <p className="client-profile-review-kicker">Contact</p>
 5767:               <h4>Contact & Communication</h4>
 5768:               <p>Review phone, email, WhatsApp/contact preference, communication notes, and correspondence protocol.</p>
 5769:               <a href="#client-contact-communication-preferences" className="client-profile-review-link">Jump to Contact Details</a>
 5770:             </article>
 5771:
 5772:             <article className="client-profile-review-card">
 5773:               <p className="client-profile-review-kicker">Location</p>
 5774:               <h4>Address & Service Location</h4>
 5775:               <p>Confirm address, service location, correspondence location, postcode, city, state, and country details.</p>
 5776:               <a href="#client-address-service-location" className="client-profile-review-link">Jump to Address Details</a>
 5777:             </article>
 5778:
 5779:             <article className="client-profile-review-card">
 5780:               <p className="client-profile-review-kicker">Matter Context</p>
 5781:               <h4>Matter Origin & Client Source</h4>
 5782:               <p>Review matter origin, client source, referral details, value indicators, and prior-firm context where applicable.</p>
TEXT_BLOCK_END

### Context for pattern employer around line 754
TEXT_BLOCK_START
  744:   "Niece",
  745:   "Son",
  746:   "Daughter",
  ...
  777:   "07": "Pulau Pinang", "34": "Pulau Pinang", "35": "Pulau Pinang",
  778:   "08": "Perak", "36": "Perak", "37": "Perak", "38": "Perak", "39": "Perak",
  779:   "09": "Perlis", "40": "Perlis",
  780:   "10": "Selangor", "41": "Selangor", "42": "Selangor", "43": "Selangor", "44": "Selangor",
  781:   "11": "Terengganu", "45": "Terengganu", "46": "Terengganu",
  782:   "12": "Sabah", "47": "Sabah", "48": "Sabah", "49": "Sabah",
TEXT_BLOCK_END
...
### Context for pattern company around line 539
TEXT_BLOCK_START
  529:
  530: const EMPLOYMENT_STATUS_OPTIONS = [
  531:   "Not Applicable / N/A",
...
### Context for pattern company around line 753
TEXT_BLOCK_START
  743:   "Nephew",
  744:   "Niece",
  745:   "Son",
...
### Context for pattern profession around line 506
TEXT_BLOCK_START
  496: const RESIDENCY_STATUS_OPTIONS = [
  497:   "Not Applicable / N/A",
  498:   "Malaysian Citizen",
...
### Context for pattern business around line 538
TEXT_BLOCK_START
  528: ];
  529:
  530: const EMPLOYMENT_STATUS_OPTIONS = [
...
### Context for pattern business around line 617
TEXT_BLOCK_START
  607:   "Unknown",
  608:   "To be confirmed",
  609:   "Other / Manual"
...
### Context for pattern business around line 5021
TEXT_BLOCK_START
 ...
 5049:                 onChange={(event) => updateForm("country", event.target.value)}
TEXT_BLOCK_END
...
### Context for pattern employmentStatus around line 86
TEXT_BLOCK_START
   76:   initials: "",
   77:
   78:   gender: "",
...
### Context for pattern employmentStatus around line 1317
TEXT_BLOCK_START
 1307:     initials: source.initials || makeInitials(givenName, surname),
 1308:
 1309:     gender,
...
### Context for pattern employmentStatus around line 3483
TEXT_BLOCK_START
 3473:         normalized.titlePrefix,
 3474:         normalized.titleSuffix,
 3475:         normalized.initials,
...
### Context for pattern employmentStatus around line 4470
TEXT_BLOCK_START
 4460:             )}
 4461:           </div>
 4462:         </div>
...
### Context for pattern employmentStatus around line 5891
TEXT_BLOCK_START
 5881:
 5882:               return (
 5883:                 <tr key={id || normalized.email || normalized.phoneNumber || normalized.nricPassportNumber}>

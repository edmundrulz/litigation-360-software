@echo off
setlocal
title L360 SAFE GIT BASELINE ONLY V2

set "WORKSPACE=C:\Users\jep_edmundrulz\litigation-360-workspace"
set "RUNNER=%WORKSPACE%\_L360_RUNNER"
set "SOURCE_PS1=%~dp0L360_SAFE_GIT_BASELINE_ONLY_V2.ps1"
set "TARGET_PS1=%RUNNER%\L360_SAFE_GIT_BASELINE_ONLY_V2.ps1"

if not exist "%SOURCE_PS1%" (
  echo ERROR: L360_SAFE_GIT_BASELINE_ONLY_V2.ps1 not found beside this BAT.
  pause
  exit /b 1
)

# ============================================================
# LITIGATION 360 LEOS
# PHASE 12.0N-R5 LEGAL ICONOGRAPHY ENHANCEMENT
#
# PURPOSE:
#   Add legal/litigation/law-firm/chambers themed symbols,
#   silhouettes, and icon-style visuals to the EXISTING integrated
#   left sidebar tools and drawer content.
#
# DESIGN GOAL:
#   - Keep everything inside the existing left sidebar
#   - No floating overlay dock
#   - Add tasteful legal industry visuals:
#       scales of justice
#       courthouse
#       gavel
#       legal document
#       briefcase
#       legal research
#       partner / chambers / firm icons
#   - Avoid mojibake by using inline SVG icons instead of raw emoji
#
# SAFE MODE:
...
function Write-Step {
    ...
    Write-Host "[PHASE 12.0N-R5] $Message" -ForegroundColor Cyan
}
...
$RollbackRoot = Join-Path $ControlRoot "rollback\PHASE-12.0N-R5-$RunStamp"
...
$PreflightRows | Export-Csv -Path (Join-Path $RollbackRoot "PHASE-12.0N-R5-PREFLIGHT-CHECK.csv") -NoTypeInformation -Encoding UTF8
...
if ($Missing.Count -gt 0) {
    ...
    $FailReport = @"
# PHASE 12.0N-R5 FAILED PREFLIGHT
...
"@
    ...
    Save-Text -Path (Join-Path $ReportRoot "PHASE-12.0N-R5-FAILED-PREFLIGHT-REPORT.md") -Content $FailReport
...
$IndexBackup = Backup-If-Exists -Source $IndexHtml -BackupFolder $RollbackRoot -Name "index.html.BACKUP-BEFORE-12.0N-R5"
$JsBackup = Backup-If-Exists -Source $JsPath -BackupFolder $RollbackRoot -Name "legal-management-enhancer.js.BACKUP-BEFORE-12.0N-R5"
$CssBackup = Backup-If-Exists -Source $CssPath -BackupFolder $RollbackRoot -Name "legal-management-enhancer.css.BACKUP-BEFORE-12.0N-R5"

Write-Pass "Backups created under:"
Write-Host $RollbackRoot -ForegroundColor Green

# ------------------------------------------------------------
# 4. CSS - sidebar integrated + iconography
# ------------------------------------------------------------
Write-Step "Writing legal iconography CSS..."

$Css = @'
/* ============================================================
   LEOS sidebar-integrated legal tools with iconography
   ============================================================ */
...
.leos-sidebar-btn-wrap {
  display: flex;
  align-items: center;
  gap: 10px;
}

.leos-sidebar-btn-icon {
  width: 24px;
  height: 24px;
  flex: 0 0 auto;
  display: grid;
...
.leos-primary-tool .leos-sidebar-btn-icon {
  background: rgba(17,24,39,0.08);
  color: #8a6612;
}

.leos-sidebar-btn-label {
  display: block;
  font-weight: 850;
}
...
# ------------------------------------------------------------
# 5. JS - sidebar integrated with legal SVG iconography
# ------------------------------------------------------------
Write-Step "Writing legal iconography JS..."
...
(function installSidebarIntegratedLegalTools() {
  ...
  function injectSidebarTools() {
    ...
    toolBox.appendChild(createToolButton("Legal Web Links", "legal-links", true, "link"));
...
$Checklist = @"
# PHASE 12.0N-R5 POST-FIX CHECKLIST
...
Original sidebar still visible.
Legal Tools still integrated into existing sidebar.
No overlap.
No broken emoji text.

You should now see legal-themed symbols / icon visuals on:
- Legal Tools title
- Legal Web Links
- Launch Apps / Docs
- Search Repository
...
And drawer/cards should also show legal-themed visuals such as:
- scales
- courthouse
- gavel
- briefcase
- document
- partner/chambers silhouettes
- legal research magnifier

## Report Back

Original 4 buttons still visible:
YES / NO

Legal Tools still inside sidebar:
YES / NO

Legal-themed icons visible:
YES / NO
...
$Report = @"
# PHASE 12.0N-R5 LEGAL ICONOGRAPHY ENHANCEMENT REPORT
...
Added legal/litigation/law-firm/chambers themed visuals to the integrated sidebar and drawers using inline SVG icons, including:

- Scales of justice
- Courthouse / chambers symbol
- Gavel
- Briefcase
- Legal document
- Partner / lawyer silhouette
- Research / magnifier
- Link / legal portal icon
- Email/news supportive icons

## Layout Rule Preserved

No floating overlay panel.
All legal tools remain integrated within the existing left sidebar.
...
Phase 12.0N-R5:
LEGAL ICONOGRAPHY ENHANCEMENT COMPLETE
...
$ReportPath = Join-Path $ReportRoot "PHASE-12.0N-R5-LEGAL-ICONOGRAPHY-ENHANCEMENT-REPORT.md"
Save-Text -Path $ReportPath -Content $Report

Write-Host ""
Write-Pass "PHASE 12.0N-R5 LEGAL ICONOGRAPHY ENHANCEMENT COMPLETE"
Write-Host ""
Write-Host "Open report:" -ForegroundColor Cyan
Write-Host 'notepad "_LEOS_CONTROL\reports\PHASE-12.0N-R5-LEGAL-ICONOGRAPHY-ENHANCEMENT-REPORT.md"'
Write-Host ""
...
Write-Host ""
Write-Pass "Paste the Phase 12.0N-R5 report and visual result back into ChatGPT."

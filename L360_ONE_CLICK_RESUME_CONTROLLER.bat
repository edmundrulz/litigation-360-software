@echo off
setlocal
title L360 ONE CLICK RESUME CONTROLLER

set "WORKSPACE=C:\Users\jep_edmundrulz\litigation-360-workspace"
set "RUNNER=%WORKSPACE%\_L360_RUNNER"
set "SOURCE_PS1=%~dp0L360_ONE_CLICK_RESUME_CONTROLLER.ps1"
set "TARGET_PS1=%RUNNER%\L360_ONE_CLICK_RESUME_CONTROLLER.ps1"

if not exist "%SOURCE_PS1%" (
  echo ERROR: L360_ONE_CLICK_RESUME_CONTROLLER.ps1 not found beside this BAT.
  pause
  exit /b 1
)
